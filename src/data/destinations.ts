...
export const destinations: Destination[] = [
  {
    ...
    heroImage: '/images/destinations/paris/paris-france-eiffel-tower-city-hero.jpg',
    images: [
      { url: '/images/destinations/paris/paris-eiffel-tower-sunset-golden-hour.jpg', caption: 'Eiffel Tower at Sunset' },
      { url: '/images/destinations/paris/paris-champs-elysees-boulevard.jpg', caption: 'Champs-Élysées' },
      { url: '/images/destinations/paris/paris-sacre-coeur-basilica-montmartre.jpg', caption: 'Sacré-Cœur Basilica' },
      { url: '/images/destinations/paris/paris-louvre-museum-art-gallery.jpg', caption: 'Louvre Museum' },
      { url: '/images/destinations/paris/paris-notre-dame-cathedral-gothic.jpg', caption: 'Notre-Dame Cathedral' },
      { url: '/images/destinations/paris/paris-seine-river-cruise-boat.jpg', caption: 'Seine River Cruise' },
    ],
    placesToVisit: [
  ...
  },
  {
    ...
    heroImage: '/images/destinations/tokyo/tokyo-japan-cityscape-night-hero.jpg',
    images: [
      { url: '/images/destinations/tokyo/tokyo-shibuya-crossing-pedestrian.jpg', caption: 'Shibuya Crossing' },
      { url: '/images/destinations/tokyo/tokyo-sensoji-temple-asakusa.jpg', caption: 'Sensō-ji Temple' },
      { url: '/images/destinations/tokyo/tokyo-mount-fuji-view-japan.jpg', caption: 'Mount Fuji View' },
      { url: '/images/destinations/tokyo/tokyo-cherry-blossoms-sakura-spring.jpg', caption: 'Cherry Blossoms' },
      { url: '/images/destinations/tokyo/tokyo-skyline-night-cityscape.jpg', caption: 'Tokyo Skyline at Night' },
      { url: '/images/destinations/tokyo/tokyo-meiji-shrine-forest-path.jpg', caption: 'Meiji Shrine' },
    ],
    placesToVisit: [
  ...
  },
  {
    ...
    heroImage: '/images/destinations/rome/rome-italy-colosseum-city-hero.jpg',
    images: [
      { url: '/images/destinations/rome/rome-colosseum-ancient-amphitheater.jpg', caption: 'The Colosseum' },
      { url: '/images/destinations/rome/rome-vatican-city-st-peters-basilica.jpg', caption: 'Vatican City' },
      { url: '/images/destinations/rome/rome-trevi-fountain-baroque.jpg', caption: 'Trevi Fountain' },
      { url: '/images/destinations/rome/rome-roman-forum-ancient-ruins.jpg', caption: 'Roman Forum' },
      { url: '/images/destinations/rome/rome-pantheon-ancient-temple.jpg', caption: 'Pantheon' },
      { url: '/images/destinations/rome/rome-spanish-steps-piazza.jpg', caption: 'Spanish Steps' },
    ],
    placesToVisit: [
  ...
  },
  {
    ...
    heroImage: '/images/destinations/london/london-uk-skyline-city-hero.jpg',
    images: [
      { url: '/images/destinations/london/london-big-ben-parliament-westminster.jpg', caption: 'Big Ben & Parliament' },
      { url: '/images/destinations/london/london-tower-bridge-thames-river.jpg', caption: 'Tower Bridge' },
      { url: '/images/destinations/london/london-buckingham-palace-royal.jpg', caption: 'Buckingham Palace' },
      { url: '/images/destinations/london/london-eye-ferris-wheel-skyline.jpg', caption: 'London Eye' },
      { url: '/images/destinations/london/london-piccadilly-circus-neon.jpg', caption: 'Piccadilly Circus' },
      { url: '/images/destinations/london/london-the-shard-skyscraper.jpg', caption: 'The Shard' },
    ],
    placesToVisit: [
  ...
  },
  {
    ...
    heroImage: '/images/destinations/dubai/dubai-uae-skyline-city-hero.jpg',
    images: [
      { url: '/images/destinations/dubai/dubai-burj-khalifa-tallest-building.jpg', caption: 'Burj Khalifa' },
      { url: '/images/destinations/dubai/dubai-palm-jumeirah-island-aerial.jpg', caption: 'Palm Jumeirah' },
      { url: '/images/destinations/dubai/dubai-marina-waterfront-yachts.jpg', caption: 'Dubai Marina' },
      { url: '/images/destinations/dubai/dubai-desert-safari-sand-dunes.jpg', caption: 'Dubai Desert Safari' },
      { url: '/images/destinations/dubai/dubai-mall-shopping-entertainment.jpg', caption: 'Dubai Mall' },
      { url: '/images/destinations/dubai/dubai-gold-souk-traditional-market.jpg', caption: 'Gold Souk' },
    ],
    placesToVisit: [
  ...
  },
  {
    ...
    heroImage: '/images/destinations/new-york/new-york-city-manhattan-hero.jpg',
    images: [
      { url: '/images/destinations/new-york/new-york-statue-of-liberty-freedom.jpg', caption: 'Statue of Liberty' },
      { url: '/images/destinations/new-york/new-york-central-park-aerial-green.jpg', caption: 'Central Park' },
      { url: '/images/destinations/new-york/new-york-times-square-neon-lights.jpg', caption: 'Times Square' },
      { url: '/images/destinations/new-york/new-york-brooklyn-bridge-skyline.jpg', caption: 'Brooklyn Bridge' },
      { url: '/images/destinations/new-york/new-york-empire-state-building-art-deco.jpg', caption: 'Empire State Building' },
      { url: '/images/destinations/new-york/new-york-manhattan-skyline-panorama.jpg', caption: 'Manhattan Skyline' },
    ],
    placesToVisit: [
  ...
  },
  {
    ...
    heroImage: '/images/destinations/istanbul/istanbul-turkey-skyline-city-hero.jpg',
    images: [
      { url: '/images/destinations/istanbul/istanbul-hagia-sophia-mosque-museum.jpg', caption: 'Hagia Sophia' },
      { url: '/images/destinations/istanbul/istanbul-blue-mosque-sultan-ahmed.jpg', caption: 'Blue Mosque' },
      { url: '/images/destinations/istanbul/istanbul-grand-bazaar-market.jpg', caption: 'Grand Bazaar' },
      { url: '/images/destinations/istanbul/istanbul-bosphorus-waterway-view.jpg', caption: 'Bosphorus View' },
  ...
  },
  {
    ...
    heroImage: '/images/destinations/sydney/sydney-australia-harbour-city-hero.jpg',
    images: [
      { url: '/images/destinations/sydney/sydney-opera-house-harbour-landmark.jpg', caption: 'Sydney Opera House' },
      { url: '/images/destinations/sydney/sydney-harbour-bridge-iconic.jpg', caption: 'Harbour Bridge' },
      { url: '/images/destinations/sydney/sydney-bondi-beach-surf-coast.jpg', caption: 'Bondi Beach' },
      { url: 'https://images.unsplash.com/photo-1598948485421-33a1655d3c38?w=800&q=80', caption: 'The Rocks District' },
      { url: '/images/destinations/sydney/sydney-darling-harbour-waterfront.jpg', caption: 'Darling Harbour' },
